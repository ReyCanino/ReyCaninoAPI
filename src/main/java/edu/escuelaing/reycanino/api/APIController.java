...
public class APIController {
    ...
    public RedirectView confirmacion(@PathVariable() String reserva) {
        try {
            ...
            return new RedirectView("https://reycanino-project.vercel.app/exito");
        } catch (Exception e) {
            Logger.getLogger(APIController.class.getName()).log(Level.SEVERE, null, e);
            return new RedirectView("https://reycanino-project.vercel.app/fallo");
        }
    }
    ...
    public ResponseEntity<List<Cliente>> buscarServicio(@PathVariable() String servicio) {
        List<Cliente> cliente = services.consultarTiendaServicio(servicio);
